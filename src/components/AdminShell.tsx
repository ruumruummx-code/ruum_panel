...
const nav = [
  ...
  { href:"/viajes", label:"Viajes", icon: Truck, badge: "8" },
      ...
      <div className="flex-1 min-w-0 flex flex-col">
        <header className="h-[64px] bg-white border-b border-slate-200 sticky top-0 z-30 flex items-center gap-3 px-4 lg:px-6">
          ...
          <div className="hidden md:flex items-center gap-2 text-sm text-slate-500">
            ...
            <span className="text-slate-900 font-medium">8 viajes activos</span>
          ...
          <div className="flex-1 flex justify-center lg:justify-start lg:ml-6">
            <div className="relative w-full max-w-[480px]">
              ...
              <input placeholder="Buscar viaje, usuario, conductor, empresa..." className="w-full h-9 rounded-xl border border-slate-200 bg-slate-50 pl-9 pr-3 text-sm placeholder:text-slate-400 focus:bg-white focus:outline-none focus:ring-2 focus:ring-[#ff4d11]/20"/>
            </div>
          </div>
