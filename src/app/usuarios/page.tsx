        ...
        {f.map(u=>(
          <Card key={u.id} className="p-5">
            ...
            <div className="grid grid-cols-3 gap-3 mt-4 text-center text-sm">
              <div className="rounded-xl bg-slate-50 border p-2"><div className="font-bold">{u.traslados}</div><div className="text-xs text-slate-500">traslados</div></div>
            ...
            <div className="flex gap-2 mt-4">
              ...
              <Button variant="ghost" size="sm" className="flex-1">Ver traslados</Button>
            </div>
          </Card>
        ))}
      </div>
