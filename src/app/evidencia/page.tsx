...
const items = [
  { viaje:"RR-24081", cliente:"Carlos Mendoza", tipo:"Inicial", fotos:6, estatus:"En revisión", conductor:"Luis Ramírez" },
  { viaje:"RR-24084", cliente:"Daniela Ruiz", tipo:"Final", fotos:8, estatus:"Aprobada", conductor:"Fernando Cruz" },
  { viaje:"RR-24085", cliente:"MasterFix", tipo:"Inicial", fotos:4, estatus:"Incompleta", conductor:"—" },
  { viaje:"RR-24087", cliente:"Aseguradora GNP", tipo:"Inicial", fotos:5, estatus:"Rechazada", conductor:"—" },
  { viaje:"RR-24083", cliente:"Grupo Bimbo", tipo:"Durante traslado", fotos:2, estatus:"Pendiente", conductor:"Jorge Herrera" },
];
  ...
  return (
    <div className="space-y-4">
      ...
      <div className="grid md:grid-cols-2 xl:grid-cols-3 gap-4">
        {items.map(i=>(
          <Card key={i.viaje} className="overflow-hidden">
            ...
            <div className="p-4">
              <div className="flex items-center justify-between">
                <span className="font-mono font-bold text-sm">{i.viaje}</span>
              ...
              <div className="flex gap-2 mt-3">
                <Link href={`/viajes/${i.viaje}`} className="flex-1"><Button variant="outline" size="sm" className="w-full">Ver viaje</Button></Link>
