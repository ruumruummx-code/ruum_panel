...
const items = [
  ...
  { traslado:"RR-24083", cliente:"Grupo Bimbo", tipo:"Durante traslados", fotos:2, estatus:"Pendiente", conductor:"Jorge Herrera" },
];
  ...
  return (
    <div className="space-y-4">
      <div className="flex items-center justify-between flex-wrap gap-3">
        <div><h1 className="text-2xl font-bold">Evidencia</h1><p className="text-sm text-slate-500">Revisión visual antes, durante y después del traslados</p></div>
        <Button variant="outline">Comparar inicial vs final</Button>
      </div>
      <div className="grid md:grid-cols-2 xl:grid-cols-3 gap-4">
        {items.map(i=>
          <Card key={i.traslados} className="overflow-hidden">
            ...
            <div className="p-4">
              <div className="flex items-center justify-between">
                <span className="font-mono font-bold text-sm">{i.traslados}</span>
              ...
              <div className="flex gap-2 mt-3">
                <Link href={`/traslados/${i.traslados}`} className="flex-1"><Button variant="outline" size="sm" className="w-full">Ver traslados</Button></Link>
