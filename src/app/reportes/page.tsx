  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid md:grid-cols-3 gap-4">
        <Card className="p-5"><div className="text-xs text-slate-500">traslados esta semana</div><div className="text-2xl font-bold">48</div><div className="text-xs text-emerald-600">+12% vs semana anterior</div></Card>
      ...
      <div className="grid lg:grid-cols-2 gap-6">
        <Card className="p-5">
          <h3 className="font-semibold">traslados por día (últimos 7 días)</h3>
      ...
      <Card className="p-5">
        ...
        <div className="overflow-x-auto mt-3">
          <table className="w-full text-sm">
            <thead className="text-xs text-slate-500 border-b"><tr><th className="text-left py-2">Conductor</th><th className="text-center py-2">traslados</th><th className="text-center py-2">Calif.</th><th className="text-right py-2">Ganancias</th></tr></thead>
